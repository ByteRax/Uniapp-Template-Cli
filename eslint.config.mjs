...
export default uni({
  ...
  rules: {
    ...
    'vue/max-attributes-per-line': 'off', // 禁用，交给格式化工具处理
    ...
    'vue/singleline-html-element-content-newline': 'off', // 禁用单行元素内容换行检查，避免与格式化工具冲突
    'vue/comma-dangle': 'off', // 禁用 Vue 文件中的尾随逗号检查，避免与格式化工具冲突

    // ==================== 样式规则 ====================
    '@stylistic/brace-style': ['error', '1tbs'],
    '@stylistic/comma-dangle': 'off', // 禁用尾随逗号检查，避免与格式化工具冲突
    '@stylistic/indent': 'off', // 禁用缩进检查，避免与格式化工具冲突
    '@stylistic/member-delimiter-style': 'off', // 禁用类型成员分隔符检查，避免与格式化工具冲突
    '@stylistic/quotes': ['error', 'single', { avoidEscape: true }],
    '@stylistic/semi': ['error', 'never'],
    'style/arrow-parens': ['error', 'always'],
    'style/comma-dangle': 'off', // 禁用尾随逗号检查，避免与格式化工具冲突
    ...
    'style/member-delimiter-style': 'off', // 禁用类型成员分隔符检查，避免与格式化工具冲突
    'style/space-before-blocks': ['error', 'always'],
    'style/space-infix-ops': ['error'],

    // ==================== 其他规则 ====================
    'antfu/if-newline': 'off', // 禁用 if 换行检查，避免与格式化工具冲突
